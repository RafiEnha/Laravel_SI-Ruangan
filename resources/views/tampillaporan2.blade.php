...
<body>
    ...
    <div class="container d-flex justify-content-center">
        <div class="col-8 ">
            <form action="/updatedata1/2/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="exampleInputEmail1">Minggu</label>
                    <input type="text" name="minggu" class="form-control" id="exampleInputEmail1"
                        aria-describedby="emailHelp" value="{{ $data->minggu }}">
                </div>
                <div class="form-group">
