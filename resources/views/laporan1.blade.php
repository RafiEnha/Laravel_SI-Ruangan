...
<body>
    ...
    <br><br><br>
    <h1 class="text-center mb-5 ">Laporan Harian</h1>

    <div class="container">
        <div class="dropdown show">
            <a href="/tambahlaporan1/1" type="button" class="btn btn-success">Tambah</a>
            <a href="/grafik1/1" type="button" class="btn btn-primary">Grafik</a>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/tampilkandata1/1/{{ $row->id }}" class="btn btn-info">Edit</a>
                            <a href="/delete1/1/{{ $row->id }}" type="button" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
                    @endforeach
