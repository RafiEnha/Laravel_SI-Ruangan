    ...
    <div class="container">
        <div class="container">
            <div class="dropdown show">
                <a href="/tambahlaporan1/2" type="button" class="btn btn-success">Tambah</a>
                <a href="/grafik1/2" type="button" class="btn btn-primary">Grafik</a>
            ...
            <div class="row">
                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach ($data as $row)
                        <tr>
                            <th scope="row">{{ $row ->minggu}}</th>
                            <td>{{ $row ->jml_peminjaman}}</td>
                            <td>
                                <a href="/tampilkandata1/2/{{ $row->id }}" class="btn btn-info">Edit</a>
                                <a href="/delete1/2/{{ $row->id }}" type="button" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                        @endforeach
